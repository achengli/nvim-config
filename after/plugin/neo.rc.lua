...
Color.new("base03", "#001b26")
Color.new("base02", "#073642")
Color.new("base01", "#7e7f83")
Color.new("base00", "#657b83")
Color.new("base0", "#d8dbe2")
...
Color.new("magenta", "#ea638c")
Color.new("violet", "#6c71c4")
Color.new("blue", "#219ebc")
Color.new("cyan", "#d8f3dc")
Color.new("green", "#06d6a0")
